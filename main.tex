...
form a set of colorings satisfying the consistency condition (\ref{eq:consistency}) and forming a superset of $S_2$.
...
\begin{lemma}\label{lemma:planar5many}
...
$$3n\ge \sum_{1\le i<j\le 5} m_{ij}\ge \sum_{1\le i<j\le 5} (n_{ij}-q)\ge 4n-10q,$$
...
\subsection{Chromatic polynomial and flow polynomial}
