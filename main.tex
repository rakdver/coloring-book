...
The usual way to deal with this issue is to argue that the considered hypothetical minimum counterexample must be $2$-connected
...
In this section, let us give a semi-fictional story of how we came up with the reducible configurations
and rules from the proof of Theorem~\ref{thm:no4cproj}.  The actual story had a bit more of a trial-and-error,
including introduction of a reducible configuration that we did not use at the end; but the cleaner version
we present here should hopefully be instructive enough.
...
Rule values via linear programming, obstructions from dual solution. (What does this mean?)
