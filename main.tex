...
\begin{lemma}\label{lemma:kempediamond}
...
that Lemma~\ref{lemma:kempediamond} has this stronger connectivity assumption.

Let $x$ and $y$ be adjacent vertices of $G$ incident only with $5$-faces, whose boundary walks
are $xyv_3v_2v_1$, $yxv_8v_7v_6$, $v_8xv_1v_{10}v_9$, and $v_3yv_6v_5v_4$, see Figure~\ref{fig-kempediamond}.
...
Let $B=\{e_1,\ldots, e_6\}$.  Consider any assignment $\psi:B\to\{1,2,3\}$ of colors to edges of $B$.
For $i\in\{1,2\}$, we say that \emph{$\psi$ extends to $G_i$} if there exists a proper $3$-edge-coloring $\varphi$
of $G_i$ such that ...
