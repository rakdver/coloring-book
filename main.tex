...
The crucial property of graphs from hyperbolic classes is that contractible neighborhoods grow exponentially
...
Let $\GG$ be a cutting-closed class graphs hyperbolic with Cheeger constant $\gamma>1$.
