...
Folding Lemma~\ref{lemma:folding} may simplify verification of the assumptions.  Vertex identification is a rather powerful
...
\subsection{Non-book proof}

Both the formulation of Theorem~\ref{thm:5choosbook} and its proof are exceptionally elegant.
However, they are something of an exception in the area, not the most typical examples of the method.
...
in the closure of $\Lambda$.  ...

The only place where the argument differs is when $|V(P)|=3$
and $K$ has a chord incident with the middle vertex of $P$, say $P=p_1p_2p_3$ and $p_2v$ is a chord of $K$.
Then, let $G_1$ and $G_2$ be proper induced subgraphs of $G$ such that $G=G_1\cup G_2$ and $G_1\cap G_2$ is the chord $p_2v$,
$p_1\in V(G_1)$ and $p_3\in V(G_2)$.  Choose the chord so that $G_2$ is minimal, and thus $p_2$ has no neihbors in $V(K\cap G_2)$
other than $v$ and $p_3$.
