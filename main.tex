...
is a strengthening of Gr\"{o}tzsch' Theorem.
...
to prove the 5-Flow and the 3-Flow Conjecture for cubic graphs (see the proof of Theorem~\ref{thm:6flow} below for a more
...
where the graph contains a vertex $v$ such that $G-v$ is planar and all vertices of $G$ other than $v$ have degree three.
...
claims.  Let us start with a weakening of the 3-Flow and the 4-Flow conjecture which follows straightforwardly from
the tools introduced in Section~\ref{sec:basicflow}.
...
However, Thomassen proved that the bound can be improved from $8$ to $6$.   To this end, he used
