...
that at least some of the Kempe chains are nontrivial.  Let us explore on several examples two important reasonings
for this: embedding restrictions and the restrictions that force simple structure of Kempe chains (in graphs of bounded
maximum degree and in edge colorings).
...
in colors $1$ and $3$ between $v_1$ and $v_3$, there cannot exist a Kempe chain in different colors $2$ and $4$ between
...
where exchanging the values of two colors may lead to invalid coloring (e.g., in circular coloring).
...
degree considerations, to prove the well-known Brooks' theorem.
