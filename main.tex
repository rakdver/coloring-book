...
giving only whe bound $w(G_{K_2})\le |f_2|-5+\varepsilon$, which is not sufficient to reach the conclusion $w(G)\le w(G_2)$.
...
Let $G_1$ be the graph obtained from $G-\{v,v_1,\ldots,v_6\}$ by identifying $v_1$, $v_3$, and $v_5$ to a new vertex $z$.
Note that no parallel edges arise by this identification by Lemma~\ref{lemma:wt5sep}.
Clearly $\varphi$ does not extend to a $5$-coloring of $G_1$, as such $5$-coloring could be extended
...
%Furthermore, we have $w_\varepsilon(f)\le w_\varepsilon(G'')\le |C|-4+2\varepsilon$, and thus $|K|<|C|$.
...
Hence, let us fix $\varepsilon=...$ and $\gamma=...$, for a face $f$ let $w(f)=\varepsilon$ if $|f|=3$ and $w(f)=|f|-7/2$ otherwise,
...
Let $L$ be an assignment of lists of size five to vertices of $G$ such that $G$ is $C$-critical for $L$-coloring,
and let $\varphi$ be an $L$-coloring of $C$ that does not extend to an $L$-coloring of $G$.
Let $G'$ be obtained from $G$ by at most BLA tripod reductions and let $C'$ be the cycle bounding $G'$.
\begin{itemize}
\item $C$ is an induced cycle,
...
$w(G)\le w(G')+2BLA\varepsilon+BLA\gamma$.
...
implying
\begin{align*}
w(G)&\le w(G')+2BlA\varepsilon+BLA\gamma\le 2BLA\varepsilon+(BLA+3)\gamma+\sum_{i=1}^3 w_\varepsilon(G_{K_i})\\
&\le |K_1|+|K_2|+|K_3|-21/2+(2BLA+3)\varepsilon+(BLA+5)\gamma\le |K_1|+|K_2|+|K_3|-10+2\varepsilon+2\gamma\\
&=|C|-4+2\varepsilon+2\gamma,
\end{align*}
...
%Furthermore, we have $w(f)\le w(G'')\le |C|-4+2\varepsilon+2\gamma$, and thus $|K|<|C|$.
...
\begin{align*}
w(G)&\le w(G')+2BLA\varepsilon+BLA\gamma\le w(G'')-(1/2-(2BLA+2)\varepsilon-(BLA+2)\gamma)\\
...
Consequently, $w(G)\le w(G')+2BLA\varepsilon$.  Suppose $G'$ contains a tripod with summit of degree at least $7$,
and let $G''$ be the corresponding tripod reduction; we have $w(G')\le w(G'')+2\varepsilon-\gamma$,
and thus $w(G)\le w(G'')+(2BLA+2)\varepsilon-\gamma\le w(G'')$, contradicting the minimality of $G$.
...
Let $L$ be an assignment of lists of size five to vertices of $G$ such that $G$ is $C$-critical for $L$-coloring,
and let $\varphi$ be an $L$-coloring of $C$ that does not extend to an $L$-coloring of $G$.
Let $G'$ be obtained from $G$ by at most QUA tripod reductions and let $C'$ be the cycle bounding $G'$.
...
by Lemma~\ref{lemma:l5-basic}.
Furthermore, $w(G)\le w(G')+2QUA\varepsilon+QUA\gamma$, and if all the tripod reductions used to create $G'$ are neutral,
then $w(G)\le w(G')+2QUA\varepsilon$.  

Let $L$ be an assignment of lists of size five to vertices of $G$ such that $G$ is $C$-critical for $L$-coloring,
Let $\varphi$ be an $L$-coloring of $C'$ that does not extend to an $L$-coloring of $G'$.  By Lemma~\ref{lemma:l5-basic},
...
and thus
\begin{align*}
w(G)&\le w(G')+2QUA\varepsilon+QUA\gamma\le w(G_3)-(1/2-(2QUA+2)\varepsilon-(QUA+2)\gamma)\\
&\le w(G_2)-(1/2-(2QUA+4)\varepsilon-(QUA+6)\gamma)\le w(G_2),
\end{align*}
...
\begin{align*}
w(G)&\le w(G')+2QUA\varepsilon=w(G_3)+2QUA\varepsilon\\
&\le w(G_2)+(2QUA+2)\varepsilon-\gamma\le w(G_2),
\end{align*}
