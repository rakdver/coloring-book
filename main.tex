...
Let $L$ be an assignment of lists of size five to vertices of $G$ such that $G$ is $C$-critical for $L$-coloring,
and let $\varphi$ be an $L$-coloring of $C$ that does not extend to an $L$-coloring of $G$.
Let $G'$ be obtained from $G$ by at most $2$ tripod reductions and let $C'$ be the cycle bounding $G'$.
\begin{itemize}
\item $C$ is an induced cycle,
\item no vertex in $V(G')\setminus V(C')$ has more than three neighbors in $C'$, and if such a vertex
has three neighbors in $C'$, then it is the summit of a tripod, and
...
$w(G)\le w(G')+4\varepsilon+2\gamma$.
...
implying
\begin{align*}
w(G)&\le w(G')+4\varepsilon+2\gamma\le 4\varepsilon+5\gamma+\sum_{i=1}^3 w_\varepsilon(G_{K_i})\\
&\le |K_1|+|K_2|+|K_3|-21/2+7\varepsilon+7\gamma\le |K_1|+|K_2|+|K_3|-10+2\varepsilon+2\gamma\\
&=|C|-4+2\varepsilon+2\gamma,
\end{align*}
...
\begin{align*}
w(G)&\le w(G')+4\varepsilon+2\gamma\le w(G'')-(1/2-6\varepsilon-4\gamma)\\
