...
\begin{theorem}\label{lemma:planar5many}
...
this would prove the Four Color Theorem!  Note however that there are plane triangulations with roots arbitrarily close to $4$.

\subsection{Deletion-contraction formula and the number of colorings}
% Mention application of deletion/contraction formula in lower bounds on the numbers of colorings?
