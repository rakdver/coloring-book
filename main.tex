...
The basic (and sometime even correct) intuition is that if a graph drawn in a surface is sufficiently generic and cannot be locally distinguished
from a planar graph, then it should behave similarly to planar graphs.  More precisely, we say that some result holds for \emph{locally planar graphs}
...
by a finite number of forbidden subgraphs, and indeed, this is sometimes substantially easier.  % AMHERE -- discuss results and methods

Coloring most of the graph

Precolorings

Crossings and other anomalies
