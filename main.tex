...
Let us now redistribute the charge according to the following rule.
\begin{itemize}
...
then $f$ sends $1/2$ to $v_2$.  If exactly one of the edges $v_1v_2$ and $v_2v_3$ is incident with a $3$-face,
then $f$ sends $3/4$ to $v_2$.  If both $v_1v_2$ and $v_2v_3$ are incident with $3$-faces, then
$f$ sends $1$ to $v_2$.
\end{itemize}
...
If $\deg(v)=4$, then $v$ receives $4\times 1/2$, $1/2+2\times 3/4$, or $2\times 1$ from the incident faces by (R2)
...
$$\finch(f)\ge \initch(v)-\frac{3}{2}|f|=\frac{|f|}{2}-6.$$
...
Hence, $f$ sends at most $1$ to one incident vertex, and $\finch(f)\ge \initch(v)-10\times 3/2-1=0$.
...
\end{proof}
