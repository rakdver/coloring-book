...
\end{align*}
By assumptions, the right-hand side is positive.  Hence, we conclude that $g\ge 3$ and 
...
\hline
3         & FC & P & NP             & ?                 & FC                & {\color{blue}FC}  & {\color{green}FC}\\
4         & FC & P & P              & {\color{blue}FC}  & {\color{green}FC} & {\color{green}FC} & {\color{green}FC}\\
5         & FC & P & FC             & {\color{green}FC} & {\color{green}FC} & {\color{green}FC} & {\color{green}FC}\\
...
\item[P]: $\FF_{k,\ell,g}$ is infinite for large enough $g$, but $k$-colorability of graphs of girth at least $\ell$ and genus at most $g$
is polynomial-time solvable for each $g$.
\item[NPC]: $k$-colorability is hard even for planar graphs.
\end{description}
